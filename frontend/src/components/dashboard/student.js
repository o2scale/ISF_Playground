...
function StudentDashboard() {
  ...
  const [chatMessages, setChatMessages] = useState({
    coach: [
      ...
      {
        sender: "me",
        message: "I'm doing great! Just finished my English lesson.",
        time: "10:32 AM",
      },
      {
        sender: "person",
        message: "That's wonderful! Did you practice the new words?",
        time: "10:33 AM",
      },
      {
        sender: "person",
        message: "Don't forget we have a group activity tomorrow!",
        time: "10:34 AM",
      },
      {
        sender: "person",
        message: "Let me know if you need any help with your homework.",
        time: "10:35 AM",
      },
      {
        sender: "person",
    ...
    admin: [
      {
        sender: "person",
        message: "Hi Arjun! Your progress report is ready.",
        time: "9:15 AM",
      },
      { sender: "me", message: "Thank you! Can I see it?", time: "9:20 AM" },
      {
        sender: "person",
        message: "Yes, you've earned 50 ISF coins this week!",
        time: "9:22 AM",
      },
      {
        sender: "person",
        message: "You can use them in the ISF shop.",
        time: "9:23 AM",
      },
      {
        sender: "person",
        message: "Your parents will be very proud of your progress.",
        time: "9:25 AM",
      },
      {
        sender: "person",
        message: "Keep learning and having fun!",
        time: "9:30 AM",
      },
      {
        sender: "person",
      ...
      <div className="main-content">
        ...
        <div className="left-panel">
          ...
          <div className="mood-selector">
            ...
            <div id="mood-message" className="mood-message">
              {moodMessage}
            </div>
          </div>
            ...
            <div className="chat-contacts">
              {chatContacts.map((contact) => (
                <div
                  ...
                  onClick={() =>
                    handleChatClick(contact.id === 1 ? "coach" : "admin")
                  }
                >
        ...
        {showChatWindow === "coach" && (
          <ChatWindow type="coach" onClose={() => setShowChatWindow(null)} />
        )}
