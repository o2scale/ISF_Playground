...
function CoachDashboard() {
  ...
  const [eventHoverPosition, setEventHoverPosition] = useState({
    top: 0,
    left: 0,
  });
  ...
  const [chatMessages, setChatMessages] = useState({
    child: [
      {
        sender: "child",
        message: "Hello Coach! How are you today?",
        time: "10:30 AM",
      },
      {
        sender: "me",
        message: "I'm doing great! How was your English lesson?",
        time: "10:32 AM",
      },
      {
        sender: "child",
        message: "It was fun! I learned new words.",
        time: "10:33 AM",
      },
      {
        sender: "child",
        message: "When is our next activity?",
        time: "10:34 AM",
      },
      {
        sender: "me",
        message: "We have a group activity tomorrow at 3 PM.",
        time: "10:35 AM",
      },
      {
        sender: "me",
        message: "Don't forget to bring your notebook.",
        time: "10:36 AM",
      },
      {
        sender: "child",
        message: "I won't forget! Thank you.",
        time: "10:40 AM",
      },
    ],
    admin: [
      {
        sender: "admin",
        message: "Hi Coach! How are the children doing?",
        time: "9:15 AM",
      },
      {
        sender: "me",
        message: "They're doing well. We completed the English module.",
        time: "9:20 AM",
      },
      {
        sender: "admin",
        message: "Great! Any issues to report?",
        time: "9:22 AM",
      },
      {
        sender: "me",
        message: "No major issues. A few children need extra help.",
        time: "9:23 AM",
      },
      {
        sender: "admin",
        message: "Let's discuss that in our meeting tomorrow.",
        time: "9:25 AM",
      },
      {
        sender: "admin",
        message: "Also, please submit your weekly report by Friday.",
        time: "9:30 AM",
      },
      {
        sender: "me",
    ...
    <div className="coach-dashboard">
      ...
      <div className="sticky-chat-buttons">
        <button
          ...
          title="Child Chat"
        >
          C<span className="sticky-chat-badge">7</span>
        </button>
        <button
          ...
          title="Admin Chat"
        >
          A<span className="sticky-chat-badge">7</span>
        </button>
      </div>
      ...
      <div className="main-content full-width">
              ...
              {balagruhas.map((balagruha) => (
                <div
                  ...
                  className={`balagruha-item ${
                    selectedBalagruha === balagruha._id ? "selected" : ""
                  }`}
                  ...
                  tasks.length > 0
                    ...
                    : [
                        // Fallback dummy data if no tasks are loaded
                        {
                          ...
                          type: "visit",
                          description:
                            "Regular visit to check on children's progress",
        ...
        {showChatWindow === "child" && (
          <ChatWindow type="child" onClose={() => setShowChatWindow(null)} />
        )}

        {showChatWindow === "admin" && (
          <ChatWindow type="admin" onClose={() => setShowChatWindow(null)} />
        )}
      </div>
    </div>
  );
